...
const questions = [
  {
    ...
    options: [
      ...
      { value: "purchased_already", label: "Purchased already" },
      { value: "refinance_renewal", label: "Refinance or renewal" },
    ],
    required: true,
